package com.linqi.aicodehelper.ai.tools;
...
public class Interview{
    ...
    /**
     * getting interview questions by keyword from mianshiya.com
     *
     * @param keyword serach keyword("Java", "Data structure" etc.)
    ...
    public String searchInterviewQuestions(@P(value = "the keyword to search") String keyword) {
        ...
        // extract interview questions from the page
